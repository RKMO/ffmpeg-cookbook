...
default[:ffmpeg][:autoconf_opts] = ['--enable-shared', '--enable-postproc', '--enable-pthreads', '--enable-gpl', '--enable-version3', '--enable-nonfree', '--enable-hardcoded-tables', '--enable-avresample', '--enable-vda', '--enable-libx264', '--enable-libmp3lame', '--enable-libxvid', '--enable-libtheora', '--enable-libvorbis', '--enable-libvpx', '--enable-libass', '--enable-libspeex', '--enable-libschroedinger', '--enable-libopenjpeg', '--enable-libfaac', '--enable-libopencore-amrnb', '--enable-libopencore-amrwb', '--enable-libtheora'];
